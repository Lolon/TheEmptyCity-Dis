...
if [ -f "E:\ProgramFiles\Epic Games\UE_4.19\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "E:\ProgramFiles\Epic Games\UE_4.19\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
